...
17. **Rollback và field gate**: `VITE_CONTINUOUS_SCAN_V2=false|off|0` quay về luồng stable; không xóa stable mode. Tính năng không hạ threshold, không upload ảnh và không cho unattended/default auto-save. Accuracy, throughput, thermal và memory thực địa tiếp tục `NOT CONFIRMED` cho tới khi corpus sequence/thiết bị đạt gate ở mục 7/11/13.
