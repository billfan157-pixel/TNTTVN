...
| `GET /api/reports/class-summary/:classId?academicYear=YYYY-YYYY` | Roster/tổng hợp lớp authoritative cho report/print/export | admin + chunhiem + phuta (service kiểm class scope) | `ClassSummaryDTO` | 403 ngoài scope, 404 không có cohort/lớp, 409 thiếu evidence lịch sử |
