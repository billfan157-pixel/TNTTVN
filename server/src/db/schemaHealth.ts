...
const REQUIRED_COLUMNS: Record<string, readonly string[]> = {
  ...
  operation_tasks: ['parish_id', 'id', 'workstream_id', 'status', 'priority', 'is_required', 'phase', 'version', 'approval_status', 'approved_by', 'approved_at', 'blocked_reason', 'cancellation_reason', 'deleted_at'],
  ...
  operation_events: ['parish_id', 'id', 'source_parish_event_id', 'scope_unit_id', 'status', 'visibility', 'outcome_summary', 'version', 'deleted_at'],
  operation_event_participants: ['parish_id', 'event_id', 'id', 'user_id', 'person_id', 'attendance_status', 'version'],
  operation_blockouts: ['parish_id', 'id', 'user_id', 'person_id', 'starts_at', 'ends_at', 'deleted_at'],
  operation_reminders: ['parish_id', 'id', 'recipient_user_id', 'trigger_at', 'kind', 'dedupe_key', 'status', 'read_at', 'enqueued_at', 'lease_expires_at', 'next_attempt_at', 'notification_id'],
