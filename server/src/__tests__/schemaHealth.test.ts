...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  operation_tasks: ['parish_id', 'id', 'workstream_id', 'status', 'priority', 'is_required', 'version', 'approval_status', 'approved_by', 'approved_at', 'blocked_reason', 'cancellation_reason', 'deleted_at'],
