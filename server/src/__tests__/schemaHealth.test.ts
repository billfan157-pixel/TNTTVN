...
const COMPOSITE_PK_TABLES = new Set([
  ...
  'operation_events',
  'operation_task_dispatches',
  'operation_event_templates',
  'operation_blockouts',
  'operation_reminders',
...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  operation_tasks: ['parish_id', 'id', 'workstream_id', 'status', 'priority', 'is_required', 'phase', 'due_at', 'scheduled_start_at', 'scheduled_end_at', 'version', 'approval_status', 'approved_by', 'approved_at', 'blocked_reason', 'cancellation_reason', 'deleted_at'],
  ...
  operation_events: ['parish_id', 'id', 'source_parish_event_id', 'source_template_id', 'source_template_version', 'scope_unit_id', 'status', 'visibility', 'outcome_summary', 'completion_record_id', 'automation_paused', 'automation_paused_at', 'automation_paused_by', 'automation_pause_reason', 'version', 'deleted_at'],
