...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  operation_events: ['parish_id', 'id', 'source_parish_event_id', 'source_template_id', 'source_template_version', 'scope_unit_id', 'event_scope_type', 'status', 'visibility', 'outcome_summary', 'completion_record_id', 'automation_paused', 'automation_paused_at', 'automation_paused_by', 'automation_pause_reason', 'version', 'deleted_at'],
