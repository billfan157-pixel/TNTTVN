...
export const ExamVariantsModal: React.FC<ExamVariantsModalProps> = ({ session, onClose }) => {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="variants-title" className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-3 backdrop-blur-sm" onClick={onClose}>
      <div className="flex max-h-[94vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-surface-border bg-surface-card shadow-2xl" onClick={event => event.stopPropagation()}>
