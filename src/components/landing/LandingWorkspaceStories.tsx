  ...
  return (
    <section aria-labelledby="tieu-de-khong-gian-lam-viec" className="flex flex-col gap-6 sm:gap-8">
      ...
      <article
        ...
        className={`scrolly-story-beat card p-6 sm:p-8 flex flex-col gap-4 border transition-colors duration-200 ${
          activeStory === 'academic'
            ? 'border-parish-primary/50 shadow-card-hover'
        ...
        <div className="block lg:hidden pt-3 border-t border-surface-border">
          <div className="rounded-2xl border border-surface-border bg-surface-app p-4 flex flex-col gap-3 shadow-xs">
            ...
            <div className="space-y-2">
              <div className="p-2.5 rounded-xl bg-surface-card border border-surface-border flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-parish-primary-light text-parish-primary font-bold text-xs flex items-center justify-center">
                    01
                  </span>
                  <div>
                    <p className="m-0 font-bold text-text-main">Maria Nguyễn Thị An</p>
                    <p className="m-0 text-xs text-text-muted">Thiếu Nhi 2A · Chuyên cần: 100%</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="p-2.5 rounded-xl bg-surface-card border border-surface-border flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="m-0 font-bold text-text-main">Giuse Trần Minh Quân</p>
                    <p className="m-0 text-xs text-text-muted">Thiếu Nhi 2A · Chuyên cần: 96%</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="badge badge-success text-xs">Có mặt</span>
              ...
              <div className="p-2.5 rounded-xl bg-surface-card border border-surface-border flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="m-0 font-bold text-text-main">Têrêsa Lê Hoàng Yến</p>
                    <p className="m-0 text-xs text-text-muted">Thiếu Nhi 2A · Có đơn xin phép</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="pt-2 border-t border-surface-border flex items-center justify-between text-xs text-text-muted">
              <span className="flex items-center gap-1">
                ...
                <span>Chuyên cần toàn lớp: 98.2%</span>
              </span>
              <span>Tổng số: 32 đoàn sinh</span>
            </div>
          </div>
        </div>
      </article>
